...
impl HandAndBet {
    ...
    pub fn hand_type(&self) -> HandType {
        if self.card_counts.iter().any(|(_, count)| *count == 5) {
            return HandType::FiveOfAKind;
        } else if self.card_counts.iter().any(|(_, count)| *count == 4) {
            return HandType::FourOfAKind;
        } else if self.card_counts.iter().any(|(_, count)| *count == 3) {
            if self.card_counts.iter().any(|(_, count)| *count == 2) {
        ...
        } else if self.card_counts.iter().any(|(_, count)| *count == 2) {
